...
%---------------------------------------------------------------------------------
%
%lcqpOASES solves (a series) of linear complementarity quadratic programming (QP) 
...
%                     lcqpOASES( H,g,A,lb,ub,lbA,ubA,C{,options{,auxInput}} )
%
%for solving the above-mentioned LCQP. H must be a symmetric (but possibly 
%indefinite) matrix and all vectors g, lb, ub, lbA, ubA have to be given
%as column vectors. C must be a symmetric matrix representing the complementarity
% product x'*L*R*x. Options can be generated using the qpOASES_options command, 
...
%                    -4: QP reached maximal penalty value without convergence.

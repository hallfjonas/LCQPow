...
/* LCQProblem */
RET_MISSING_COMPLEMENTARITIES,					/**< Missing complementarities, use QProblem instead. */
RET_MISSING_COMPLEMENTARITY_MATRIX,				/**< Complementarity matrix passed matched null pointer. */
RET_MISSING_WEIGHTS,							/**< Missing complementarity weights. */
RET_PENALTY_GRADIENT_UPDATE_FAILED,				/**< Updating the gradient of penalty function failed. */
/* SQProblem */

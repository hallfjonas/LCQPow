...
class Options
{
	...
	public:
		...
		real_t complementarityTolerance;		/**< Complementarity tolerance. */
		real_t initialComplementarityPenalty;	/**< Start value for complementarity penalty term. */
		real_t complementarityPenaltyUpdate;	/**< Factor for updating penaltised complementarity term. */
};

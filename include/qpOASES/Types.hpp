...
/** Summarises all possible states of bounds and constraints. */
enum ComplementarityStatus
{
	COMP_UNSATISFIED = -1,	/**< Unsatisfied complementarity constraints. */
	COMP_GROWING = 0,		/**< Meaning that in the current iteration the penalty value has been increased. */
	COMP_SATISFIED = 1,		/**< Satisfied complementarities. */
	GRADIENT_UPDATED = 2
};

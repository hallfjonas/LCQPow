 ...
 *	\date 2007-2017
 */
class LCQProblem : public LCQProblemB
{
	...
	public:
		...
		LCQProblem(	const LCQProblem& rhs	/**< Rhs object. */
					);
		...
		virtual LCQProblem& operator=(	const LCQProblem& rhs	/**< Rhs object. */
								);
	...
	protected:
		...
		/** Solves a LCQProblem whose QP data is assumed to be stored in the member variables.
		...
		/** Solves LCQProblem using online active set strategy.
		 ...
		 *	\return SUCCESSFUL_RETURN \n
					RET_SETUPSUBJECTTOTYPE_FAILED */
		using LCQProblemB::setupSubjectToType;
		...
		returnValue performStep(	const real_t* const delta_g,		/**< Step direction of gradient. */
									...
									const real_t penVal,				/**< Current complementarity penalty value. */
									const real_t* const g_original,		/**< Original objective's linear term. */
									int_t& BC_idx, 						/**< Output: Index of blocking constraint. */
		...
		returnValue sufficientDecrease();

		/** Update the gradient according to sufficient decrease.
		 *  \return SUCCESFUL_RETURN */
		returnValue gradientLineSearch(	const real_t* const g,	/**< Gradient of original LCQP. */
										real_t& _g_update		/**< New gradient post update. */
										);
		 ...
		 *			RET_SETUP_AUXILIARYQP_FAILED \n
					RET_INVALID_ARGUMENTS */
		using LCQProblemB::setupAuxiliaryQP;

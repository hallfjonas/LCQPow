...
returnValue Options::setToDefault( )
{
	...
	complementarityTolerance      = 1.0e3 * EPS;
...
returnValue Options::setToReliable( )
{
	...
	complementarityPenaltyUpdate  = 1.2;
...
returnValue Options::setToMPC( )
{
	...
	complementarityTolerance      = 1.0e9 * EPS;
	initialComplementarityPenalty = 0.01;
	complementarityPenaltyUpdate  = 1.75;
...
returnValue Options::ensureConsistency( )
{
    ...
    */
	...
	if ( complementarityTolerance <= 0.0 )
	{
		complementarityTolerance = EPS;
		needToAdjust = BT_TRUE;
	}

	if ( initialComplementarityPenalty <= 0.0 )
	{
		initialComplementarityPenalty = 0.01;
		needToAdjust = BT_TRUE;
	}
...
returnValue Options::print( ) const
{
	...
	snprintf( myPrintfString,MAX_STRING_LENGTH,"complementarityTolerance   =  %e\n",complementarityTolerance );
	myPrintf( myPrintfString );

	snprintf( myPrintfString,MAX_STRING_LENGTH,"initialComplementarityPenalty   =  %e\n",initialComplementarityPenalty );
	myPrintf( myPrintfString );

	snprintf( myPrintfString,MAX_STRING_LENGTH,"complementarityPenaltyUpdate   =  %e\n",complementarityPenaltyUpdate );
	myPrintf( myPrintfString );
